...
1. Entry point. The guest could click the "Log in" button from:
   * The Home screen
   * Some [product collection](#us-4-explore-sciart-products-collections)
   * Some [product details](#us-5-explore-sciart-products-details) 
   * The registration form in [Registering](#us-2-registering)
2. The guest introduces their user credentials
...
1. The guest introduces their email address in the quick registration form in the Home screen
...
1. The guest enters their email inbox
...
2. The guest clicks the "Join hackathon" button of the hackathon they want to join
3. The guest fills a quick registration + joining form (minimal information)
4. The guest is prompted to [explore seed collections](#us-4-explore-sciart-products-collections)
...
#### US-3B: Join from [direct registration](#us-2a-direct-registration) or [complete registration](#us-2c-complete-registration)
  ...
  1. The participant may get more information about the [methodology format](#us-6-view-detailed-information-about-the-methodology-format) by clicking the "What is a hackathon?" button
  2. If the participant does not want to join:
    
      i. The participant clicks the "Maybe later" button

      ii. The participant is prompted to [explore previous editions](#us-11-view-the-list-of-previous-editions) or get more information about the [methodology format](#us-6-view-detailed-information-about-the-methodology-format)

  3. If the participant wants to join:

      i. The participant clicks the hackathon they want to join
...
#### US-3C: Join from [hackathon list](#us-7-view-the-list-of-incoming-hackathons)
  ...
  2. The participant clicks the "Join hackathon" button of the hackathon they want to join
...
#### US-3E: Join to some hackathon from its [seed collection](#us-4-explore-sciart-products-collections)
...
2. The user selects the product they want to explore (seeds, flowers or fruits)
...
#### US-4C: Access product collections from the [edition details screen](#us-12-view-the-details-of-some-previous-edition)

1. The user accesses the details screen of some edition
2. The user clicks the product they want to explore (seeds, flowers or fruits)
3. The user is redirected to the collection screen of the selected product

#### US-4D: Access product collections after [Joining a hackathon](#us-3-joining-a-hackathon)
...
If the user is on some collection screen, they can navigate between seed, flower and fruit collection screens.
...
#### US-5A: Access product details from other [collections](#us-4-explore-sciart-products-collections)

 1. The user accesses some product collection
 2. The user clicks the "See more" button of the specific product of which they want to see the details
...
#### US-5D: Access seed details from the carousel shown after [joining a hackathon](#us-3-joining-a-hackathon)
 ...
 1. The user clicks the "Know more" button in the seeds carousel shown after joining a hackathon
...
1. Entry point:
    ...
    * From [Joining a hackathon](#us-3-joining-a-hackathon)
...
1. The participant accesses the [hackathons screen](#us-7-view-the-list-of-incoming-hackathons)
...
1. The participant enters some seed collection screen
2. The participant clicks the like button of the seed they like

#### US-14B: From [seed details](#us-5-explore-sciart-products-details)

1. The participant enters the seed details screen
...
If the participant wants to change the collection shown, they can click the dropdown show on the screen and select their preferred collection.
...
2. The participant clicks the unlike button of the seed they do not like anymore
...
1. The participant clicks the "Enter exploring groups" button, shown in the [hackathon screen](#us-13-access-hackathon-main-screen) after the Facilitators have created exploring groups
...
1. The participant [enters the exploring group screen](#us-17-enter-my-exploring-group)
...
3. The participant shares their screen, if necessary
4. The participant presents the conceptual map of their exploring group
...
2. The participant clicks the rating they want to assign to each seed
3. After all the presentations are finished, the participant reviews and confirms their ratings
...
1. The participant enters the [co-creation team screen](#us-25-enter-my-co-creation-team)
